...
vector<int> fac(2e5 + 1, 1);
vector<int> minv(2e5 + 2, 1);
...
void solve(int tc){
    ...
    each(e, a) {
        if (e > big) {
            big2 = big;
            big = e;
        } else if (e > big2) big2 = e;
    }
    if (big - big2 > 1) cout << 0 << endl;
    else if (big - big2 == 1) cout << (fac[n] * ct[big2] % 998244353) * minv[ct[big2] + 1] % 998244353 << endl;
